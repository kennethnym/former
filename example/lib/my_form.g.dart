...
mixin _$MyForm on _MyForm {
  @override
  final Map<FormerField, String> fieldType = {
    MyFormField.username: 'String',
    MyFormField.email: 'String',
    MyFormField.age: 'int?',
    MyFormField.shouldSendNewsletter: 'bool',
    MyFormField.shouldEnableAnalytics: 'bool'
  };
